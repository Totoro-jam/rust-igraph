...
| ALGO-CC-032 | Site percolation (Graph + vertex order — incremental site activation) | percolation.c (remaining) | 277 | adapt | CC-030 | todo | - | - | - |
