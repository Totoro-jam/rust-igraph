    ...
    "rust-igraph Benchmarks": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "99b09b95754df324ecba92fb211e30571eea1841",
          "message": "fix(algo-tr): resolve clippy pedantic lints in core_profile_indices\n\n- Add #[allow(clippy::cast_precision_loss)] for usize→f64 casts\n- Wrap identifiers in backticks for doc_markdown lint\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-06-12T12:26:30+08:00",
          "tree_id": "bb8caa3911856e7904cbc47b5c50799804b9bf24",
          "url": "https://github.com/Totoro-jam/rust-igraph/commit/99b09b95754df324ecba92fb211e30571eea1841"
        },
        "date": 1781239129672,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "289f47d7a51597d1464be1c4cee4e94c5e75cd75",
          "message": "feat(algo-tr): ALGO-TR-123 edge distribution entropy indices\n\nImplement three edge-distribution characterisation indices:\n- edge_degree_entropy: Shannon entropy of edge degree-pair distribution\n  (classifies edges by (min_deg, max_deg) of endpoints)\n- edge_weight_balance: normalised entropy (0=single class, 1=uniform)\n- degree_pair_concentration: fraction of edges in the dominant class\n\n14 unit tests + 3 doctests. O(E) complexity.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-06-12T12:39:17+08:00",
          "tree_id": "3265909aeb3ecce6dd9b86c62a07bff067b06c81",
          "url": "https://github.com/Totoro-jam/rust-igraph/commit/289f47d7a51597d1464be1c4cee4e94c5e75cd75"
        },
        "date": 1781239921575,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "51c6a515ce27b4095a3324717611f8c0aed43be9",
          "message": "feat(algo-tr): ALGO-TR-124 clustering profile indices\n\nImplement three local clustering coefficient distribution indices:\n- clustering_variance: population variance of local CC values\n- clustering_entropy: normalised Shannon entropy of binned CC histogram\n- clustering_bimodality: Sarle's bimodality coefficient of CC distribution\n\n10 unit tests + 3 doctests. O(V·deg²) via triangle enumeration.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-06-12T13:51:52+08:00",
          "tree_id": "7235aaa6c7662c336564b0432bcb1a76445e8efe",
          "url": "https://github.com/Totoro-jam/rust-igraph/commit/51c6a515ce27b4095a3324717611f8c0aed43be9"
        },
        "date": 1781244247828,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "8b59203b2f8a315fff22a88750e0e373ea52dafc",
          "message": "feat(algo-tr): ALGO-TR-125 distance profile indices\n\nImplement three hop-distance distribution indices:\n- hop_entropy: normalised Shannon entropy of the distance histogram\n- distance_gini: Gini coefficient of pairwise distances\n- reach_decay: average fraction of vertices reachable within half diameter\n\n10 unit tests + 3 doctests. O(V²) via all-pairs BFS.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-06-12T15:08:41+08:00",
          "tree_id": "9cc45e78bd9b4396ed0c47eb5fa35fce50daa330",
          "url": "https://github.com/Totoro-jam/rust-igraph/commit/8b59203b2f8a315fff22a88750e0e373ea52dafc"
        },
        "date": 1781248855534,
        "tool": "cargo",
        "benches": [
