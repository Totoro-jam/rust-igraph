...
var I18N = {
  en: {
    ...
    'hero.sub': '1,291 APIs. Zero <code>unsafe</code>. One dependency. Runs natively and in the browser via WASM.',
  ...
  zh: {
    ...
    'hero.sub': '1,291 公开 API、零 <code>unsafe</code>、仅一个依赖。原生运行，也可通过 WASM 在浏览器中执行。',
    'hero.try': '在线体验',
    'hero.start': '开始使用',
    'stats.apis': '公开 API',
    'stats.algos': '算法',
