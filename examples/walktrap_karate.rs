//! ALGO-CO-008 demo: load Zachary's karate club, run Pons-Latapy walktrap
//! community detection (random walks of length 4), and print the best-Q
//! partition along with the dendrogram modularity trajectory.
//!
//! Run from the repo root: `cargo run --example walktrap_karate`.
...
use rust_igraph::{WalktrapResult, modularity, walktrap};

fn print_result(g: &rust_igraph::Graph, r: &WalktrapResult) {
    let k = r.nb_clusters;
